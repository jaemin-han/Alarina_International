...
function getCompany(req, res, next) {
  db.one(`SELECT company.company_name, company.company_description, company.industry, company.city, company.website, job.position, job.description, job.city, job.date_created
          FROM company
          LEFT JOIN job
